...
Como nos é dada uma determinada cidade, basta apenas procurar essa cidade no \textit{array} \textbf{\small\texttt{CITIES}} e retornar o \textit{array} \textbf{\small\texttt{positions}} correspondente, pois desta forma apenas iremos aceder às posições do \textit{array} \textbf{\small\texttt{RIDES}} que pretendemos.
